    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [Kyura-Userbot](https://github.com/Kyuraxp/Kyura-Userbot)"
            buttons=[
                (
...
async def infor(event):
        await tgbot.send_message(
            event.chat_id,
            message=f"**Channel**: [Support Channel](t.me/kyuraprojects)\n**Github**: [Kyura-Userbot](https://github.com/Kyuraxp/Kyura-Userbot)\n**Deploy**: [Heroku](https://telegram.dog/XTZ_HerokuBot?start=S3l1cmF4cC9reXVyYS11c2VyYm90IEt5dXJhLVVzZXJib3Q)",
            buttons=[
                [
                    custom.Button.inline(
                        "ᴄʟᴏꜱᴇ",
